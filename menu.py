...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelTitle.setGeometry(QtCore.QRect(270, 0, 201, 20))
        self.labelTitle.setObjectName("labelTitle")
        self.buttonOpen = QtWidgets.QPushButton(self.centralwidget)
        self.buttonOpen.setGeometry(QtCore.QRect(400, 50, 75, 23))
        self.buttonOpen.setObjectName("buttonOpen")
        self.comboBoxMain = QtWidgets.QComboBox(self.centralwidget)
        self.comboBoxMain.setGeometry(QtCore.QRect(40, 50, 351, 22))
        ...
        self.labelMenu.setGeometry(QtCore.QRect(40, 30, 131, 16))
        self.labelMenu.setObjectName("labelMenu")
        self.mdiArea = QtWidgets.QMdiArea(self.centralwidget)
        self.mdiArea.setGeometry(QtCore.QRect(10, 90, 831, 461))
        ...
        self.scrollArea.setGeometry(QtCore.QRect(90, 120, 601, 221))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 599, 219))
        ...
        self.labelBelong_one.setGeometry(QtCore.QRect(90, 90, 71, 16))
        ...
        self.labelTittle_three.setGeometry(QtCore.QRect(260, 10, 241, 20))
        self.labelTittle_three.setObjectName("labelTittle_three")
        self.buttonBelongsL = QtWidgets.QPushButton(self.subwindow_three)
        self.buttonBelongsL.setGeometry(QtCore.QRect(70, 170, 75, 23))
        self.buttonBelongsL.setObjectName("buttonBelongsL")
        self.label_6 = QtWidgets.QLabel(self.subwindow_three)
        self.label_6.setGeometry(QtCore.QRect(70, 90, 81, 16))
        self.label_6.setObjectName("label_6")
        self.labelResult = QtWidgets.QLabel(self.subwindow_three)
        self.labelResult.setGeometry(QtCore.QRect(70, 220, 521, 16))
        self.labelResult.setObjectName("labelResult")
        self.label_8 = QtWidgets.QLabel(self.subwindow_three)
        self.label_8.setGeometry(QtCore.QRect(270, 90, 81, 16))
        self.label_8.setObjectName("label_8")
        self.label_7 = QtWidgets.QLabel(self.subwindow_three)
        self.label_7.setGeometry(QtCore.QRect(210, 120, 47, 13))
        self.label_7.setObjectName("label_7")
        self.lineEditDeterminant = QtWidgets.QLineEdit(self.subwindow_three)
        self.lineEditDeterminant.setGeometry(QtCore.QRect(70, 120, 113, 20))
        ...
        self.lineEditDetermined.setGeometry(QtCore.QRect(270, 120, 113, 20))
        self.lineEditDetermined.setObjectName("lineEditDetermined")
        self.labelFile_three = QtWidgets.QLabel(self.subwindow_three)
        self.labelFile_three.setGeometry(QtCore.QRect(150, 170, 591, 16))
        ...
        self.labelTittle_four.setGeometry(QtCore.QRect(250, 10, 241, 20))
        self.labelTittle_four.setObjectName("labelTittle_four")
        self.scrollArea_3 = QtWidgets.QScrollArea(self.subwindow_four)
        self.scrollArea_3.setGeometry(QtCore.QRect(90, 140, 601, 221))
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollArea_3.setObjectName("scrollArea_3")
        self.scrollAreaWidgetContents_3 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 599, 219))
        ...
        self.labelBelong_one_2.setGeometry(QtCore.QRect(90, 110, 71, 16))
        ...
        self.buttonCalculateKeys.setGeometry(QtCore.QRect(330, 380, 75, 23))
        self.buttonCalculateKeys.setObjectName("buttonCalculateKeys")
        self.scrollArea_5 = QtWidgets.QScrollArea(self.subwindow_five)
        self.scrollArea_5.setGeometry(QtCore.QRect(70, 150, 601, 221))
        self.scrollArea_5.setWidgetResizable(True)
        self.scrollArea_5.setObjectName("scrollArea_5")
        self.scrollAreaWidgetContents_4 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 599, 219))
        ...
        self.labelBelong_one_3.setGeometry(QtCore.QRect(70, 120, 71, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelTitle.setText(_translate("MainWindow", "====== BASES DE DATOS I ======"))
        self.buttonOpen.setText(_translate("MainWindow", "Abrir"))
        self.comboBoxMain.setItemText(0, _translate("MainWindow", "1. Calcular cierre de L+ - Archivo JSON"))
        self.comboBoxMain.setItemText(1, _translate("MainWindow", "2. Calcular cierre de L+ - Manual"))
        self.comboBoxMain.setItemText(2, _translate("MainWindow", "3. Indicar si DF pertenece a L+"))
        ...
        self.labelTittle_one.setText(_translate("MainWindow", "====== CALCULAR CIERRE DE L+ - ARCHIVO JSON ======"))
        ...
        self.labelTittle_two.setText(_translate("MainWindow", "====== CALCULAR CIERRE DE  L+ - MANUAL======"))
        ...
        self.labelTittle_three.setText(_translate("MainWindow", "====== DF PERTENECE AL CIERRE L+ ======"))
        self.buttonBelongsL.setText(_translate("MainWindow", "Cargar L"))
        self.label_6.setText(_translate("MainWindow", "IMPLICANTE"))
        self.labelResult.setText(_translate("MainWindow", "Resultado:"))
        self.label_8.setText(_translate("MainWindow", "IMPLICADO"))
        self.label_7.setText(_translate("MainWindow", "==>"))
        self.labelFile_three.setText(_translate("MainWindow", "Buscar Json con L"))
        self.subwindow_four.setWindowTitle(_translate("MainWindow", "Recubrimiento mínimo"))
        self.labelTittle_four.setText(_translate("MainWindow", "====== RECUBRIMIENTO MÍNIMO ======"))
        ...
        self.labelTittle_five.setText(_translate("MainWindow", "====== CALCULO DE LLAVES ======"))
